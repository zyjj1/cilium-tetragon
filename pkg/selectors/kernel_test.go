...
func TestReturnSelectorEmpty(t *testing.T) {
	...
	expU32Push(0) // off: 4       relative ofset of selector
...
func TestReturnSelectorArgInt(t *testing.T) {
	...
	expU32Push(argTypeInt)   // off: 88      selector: matchReturnArgs[0].Type
...
func TestReturnSelectorArgIntActionFollowfd(t *testing.T) {
	...
	expU32Push(4)  // off: 12      selector: matchReturnArgs length
	expU32Push(28) // off: 16      selector: matchReturnActions length
	expU32Push(0)  // off: 16      selector: selectors.ActionTypePost
	expU32Push(0)  // off: 16      selector: rateLimit
	expU32Push(0)  // off: 16      selector: stackTrace
	expU32Push(1)  // off: 16      selector: selectors.ActionTypeFollowFd
	expU32Push(7)  // off: 16      selector: action.ArgFd
	expU32Push(8)  // off: 16      selector: action.ArgName
